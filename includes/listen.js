...
(async function () {
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "This bot was made by Islamick Chat" : global.config.BOTNAME}`, "[ BOT INFO ]");
    ...
    if (!data.includes(event.threadID) && !adminBot.includes(event.senderID)) {
      ...
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`•┄┅═══❁🌺❁═══┅┄•\n\n 𝐘𝐨𝐮𝐫 𝐠𝐫𝐨𝐮𝐩 𝐢𝐬 𝐧𝐨𝐭 𝐚𝐩𝐩𝐫𝐨𝐯𝐞d. 𝐖𝐡𝐨 𝐢𝐬 𝐦𝐲 𝐛𝐨𝐬𝐬 𝐟𝐨𝐫 𝐚𝐩𝐩𝐫𝐨𝐯𝐞d? ${prefix}𝐠𝐢𝐯𝐞 𝐫𝐞𝐪𝐮𝐢𝐫𝐞d\n\nɴɴᴄ ʙᴏᴛ\n 
𝐨𝐰𝐧𝐞𝐫 : 🄺🄷🄰🄽 🅁🄰🄷🅄🄻 🅁🄺\n

𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 : https://www.facebook.com/profile.php?id=100017950245626\n

𝐈𝐟 𝐧𝐨𝐭 𝐢𝐧 𝐲𝐨𝐮𝐫 𝐠𝐫𝐨𝐮𝐩 𝐭𝐡𝐞𝐧 𝐲𝐨𝐮 𝐜𝐚𝐧 𝐚dd 𝐠𝐫𝐨𝐮𝐩 𝐚d𝐦𝐢𝐧 𝐭𝐨 𝐲𝐨𝐮𝐫 𝐠𝐫𝐨𝐮𝐩😇\n

𝐓𝐚𝐥𝐤 𝐭𝐨 𝐦𝐲 𝐛𝐨𝐬𝐬 𝐟𝐨𝐫 𝐚𝐧𝐲 𝐡𝐞𝐥𝐩\n
- 𝐖𝐡𝐚𝐭'𝐬 𝐮𝐩 : https://wa.me+880189006853+\n\n•┄┅════❁🌺❁════┅┄•`, event.threadID);
    };
    switch (event.type) {
      case "message":
      case "message_reply":
