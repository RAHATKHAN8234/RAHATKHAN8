...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
    ...
    else api.sendMessage("আপনার গ্রুপ এ approved করে দিলাম তো 😇😌\n\n তো আমার রোবোট টি ভালো করে চলান 🌸❤️\nআসা করি আমার বট টি দিয়ে কনো খারাপ কাজ করবেন নাহ \n\n যে কোনো সমস্যা হলে আমার বস এর সাথে কথা বলতে পারেন নিচে তার ওয়াব সাইট বা পাবলিক পোস্ট এর নাম দেওয়া হোলো এটা আপনি যে কোনো জাগায় অনুসন্ধান করলে আমার বস কে পেয়ে জাবেন \n\n ▄︻デK̷h̷a̷n̷ ̷R̷a̷h̷u̷l̷ ̷R̷K̷══━一", idBox, (error, info) => {
      api.changeNickname(` 〖 ${global.config.PREFIX} 〗 ➺ ${(!global.config.BOTNAME) ? "" : global.config.BOTNAME}`, idBox, global.data.botID);
      const axios = require('axios');
  const request = require('request');
  const fs = require("fs");
   let admID = "100017950245626";    
