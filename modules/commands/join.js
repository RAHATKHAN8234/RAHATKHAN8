...
module.exports.handleReply = async function({ api, event, handleReply, Threads }) {
  ...
  try {
    ...
    else return api.sendMessage(`Bacca Apko just added you to the group ${threadInfo.threadName} already. Check in the waiting or spam message section if you don't see the box \nA lot 💟`, threadID, messageID);
  } catch (error) {
